...
def main():
    ...
    if training_args.do_eval:
        ...
        output_eval_file = os.path.join(training_args.output_dir, data_args.eval_data_type+"_eval_results.txt")
    ...
    if training_args.do_predict:
        ...
        # Save predictions
        output_test_results_file = os.path.join(training_args.output_dir, data_args.eval_data_type+"_test_results.txt")
        if trainer.is_world_process_zero():
