...
def main():
    ...
    wandb.init(project="multiNER_final", name=data_args.wandb_name) # need check
    ...
    if "RoBERTa" in model_args.model_name_or_path or "biolm" in model_args.model_name_or_path or 'finetuned' in model_args.model_name_or_path:
        # roberta
    ...
    if training_args.do_predict:
        ...
        wandb.log({"test_precision": metrics['test_precision'],
