...
def main(args):
    ...
    disease_train_dictionary=load_dictionary(dictionary_path=args.dictionary_path)
    ...
    print(len(result_evalset['queries']))
    ...
    if args.save_predictions:
        ...
        output_file = os.path.join(args.output_dir,f"{dataset_name}_predictions_eval.json")
