...
class QueryDataset(Dataset):
    ...
    def load_data(self, data_dir, filter_composite, filter_duplicate, filter_cuiless):
        ...
        data : np.array 
            mention, cui pairs
        """
        entity_type={'bc5cdr-chemical':'chemical','bc5cdr-disease':'disease','medmention_function':'function','medmention_diagnosis':'diagnosis',
                   'medmention_function':'function','medmention_treatment':'treatment','bc2gm':'gene','CAFETERIA':'food',
                  'CONLL2003':'location','JNLPBA-ct':'celltype','nero_bodypart':'bodypart'}
        dataset_name=data_dir.split('/')[2]
        #entity_type=entity_type[dataset_name]
        data = []
        ...
        for concept_file in concept_files:
            ...
            for concept in concepts:
                ...
                #data.append((mention,cui,entity_type))
